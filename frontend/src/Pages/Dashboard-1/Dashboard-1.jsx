...
function Dashboard1(){
    ...
    return (
      <section id="dashboard1main">
        ...
        <h1 id="dashboard1typewriter">NexOptima - Productivity Management Platform</h1>
        <SlideShow></SlideShow>
        <section id="dashboard1body">
          <section id="dashboard1admin" class="dashboard1bodychild">
            <img src="/img/admin-img.png" class="dashboard1bodyimg"></img>
          ...
          <section id="dashboard1manager" class="dashboard1bodychild">
            <img src="/img/employee-img.png" class="dashboard1bodyimg"></img>
            <Div className="dashboard1bodydiv">
              <Para
                text={
          ...
          <section id="dashboard1employee" class="dashboard1bodychild">
            <img src="/img/manager-img.png" class="dashboard1bodyimg"></img>
            <Div className="dashboard1bodydiv">
              <Para
                text={
